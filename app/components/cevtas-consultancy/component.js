System.register(['angular2/core', '../cevtas-hero/component', '../cevtas-section/component', '../cevtas-testimonials/component', '../cevtas-cta/component', '../cevtas-partners/component', '../cevtas-footer/component'], function(exports_1) {
    ...
    return {
        ...
        execute: function() {
            CevtasConsultancy = (function () {
                function CevtasConsultancy() {
                }
                CevtasConsultancy = __decorate([
                    core_1.Component({
                        selector: 'cevtas-consultancy',
                        templateUrl: 'app/components/cevtas-consultancy/index.html',
                        host: {
                ...
                return CevtasConsultancy;
            })();
            exports_1("CevtasConsultancy", CevtasConsultancy);
        }
    }
});

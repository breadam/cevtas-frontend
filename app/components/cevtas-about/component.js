System.register(['angular2/core', '../cevtas-hero/component', '../cevtas-section/component', '../cevtas-testimonials/component', '../cevtas-cta/component', '../cevtas-partners/component', '../cevtas-footer/component'], function(exports_1) {
    ...
    return {
        ...
        execute: function() {
            CevtasAbout = (function () {
                function CevtasAbout() {
                }
                CevtasAbout = __decorate([
                    core_1.Component({
                        selector: 'cevtas-about',
                        templateUrl: 'app/components/cevtas-about/index.html',
                        host: {
            ...
            exports_1("CevtasAbout", CevtasAbout);
        }
    }
});

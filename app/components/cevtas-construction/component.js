System.register(['angular2/core', '../cevtas-hero/component', '../cevtas-section/component', '../cevtas-testimonials/component', '../cevtas-cta/component', '../cevtas-partners/component', '../cevtas-footer/component'], function(exports_1) {
    ...
    return {
        ...
        execute: function() {
            CevtasConstruction = (function () {
                function CevtasConstruction() {
                }
                CevtasConstruction = __decorate([
                    core_1.Component({
                        selector: 'cevtas-construction',
                        templateUrl: 'app/components/cevtas-construction/index.html',
                        host: {
                ...
                return CevtasConstruction;
            })();
            exports_1("CevtasConstruction", CevtasConstruction);
        }
    }
});
